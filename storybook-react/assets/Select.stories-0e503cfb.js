import{j as b}from"./jsx-runtime-29545a09.js";import{t as W,d as X}from"./util-d0dbe7b8.js";import{c as J}from"./clsx.m-1229b3e0.js";import{r as K}from"./index-76fb7be0.js";import"./index-8d47fad6.js";import"./_commonjsHelpers-de833af9.js";const i=K.forwardRef(({busy:e,invalid:t,required:r,className:o,noscript:n,children:a,...x},U)=>b("select",{"aria-busy":e||void 0,"aria-invalid":t||void 0,required:n?r:!1,"aria-required":n?void 0:r||void 0,className:J("utrecht-select","utrecht-select--html-select",e&&"utrecht-select--busy",t&&"utrecht-select--invalid",r&&"utrecht-select--required",o),ref:U,...x,children:a}));i.displayName="Select";const Q=K.forwardRef(({disabled:e,invalid:t,value:r,children:o,className:n,...a},x)=>b("option",{...a,ref:x,disabled:e,value:r,className:J("utrecht-select__option",e&&"utrecht-select__option--disabled",t&&"utrecht-select__option--invalid",n),children:o}));Q.displayName="SelectOption";try{i.displayName="Select",i.__docgenInfo={description:"",displayName:"Select",props:{busy:{defaultValue:null,description:"",name:"busy",required:!1,type:{name:"boolean"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},noscript:{defaultValue:null,description:"`noscript`: Don't let it affect CSS :invalid",name:"noscript",required:!1,type:{name:"boolean"}}}}}catch{}const Y=`<!-- @license CC0-1.0 -->
...
}`,...(_=(q=c.parameters)==null?void 0:q.docs)==null?void 0:_.source}}};var k,V,T;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    required: true,
    options
  }
}`,...(T=(V=d.parameters)==null?void 0:V.docs)==null?void 0:T.source}}};var R,D,H;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    required: true,
    noscript: true,
    options
  }
}`,...(H=(D=u.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};var O,N,w;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    invalid: true,
    options
  }
